...
HOTEL_CATEGORY_KEYWORDS = {
    '蔬菜类': [
        ...
        '波菜', '生姜', '姜', '白萝卜', '红心萝卜', '樱桃小萝卜', '萝卜苗', '象牙白萝卜', '花心萝卜', '净笋', '线椒', '黄芽菜', '菜心', '净蒜', '去皮蒜', '扒皮蒜', '新蒜', '白葱',
    ...
    '饮品乳品类': ['果溢多橙汁', '果溢多桃汁', '果溢多橙子', '果溢多猕猴桃汁', '冰红茶', '冰峰罐装', '冰峰瓶装', '瓶装冰峰', '伊利益消益生菌优酪酸奶', '伊利风味发酵乳复原乳酸奶', '益生菌发酵酸奶', '纯牛奶', '冰峰', '酸梅汤', '酸奶', '橙汁', '牛奶', '饮料', '果汁', '矿泉水'],
    '冻货类': ['玉米红枣糕', '玉米发糕', '花卷', '火锅杂类丸子蟹排', '火锅油条', '荷叶饼', '小油条', '牛柳条', '蟹排', '冻', '冷冻', '冻玉米', '冻货', '冻品', '火锅丸子', '馄饨', '丸子', '鸡块', '什锦菜', '猪头肉', '里昂火腿', '王中王火腿'],
    '饼干': ['黑全麦面包', '原味面包', '饼干', '曲奇'],
}
HOTEL_CATEGORY_OVERRIDES = {
    ...
    '蔬菜类': ['水洗铁棍山药', '铁棍山药', '山药', '黄土豆', '贝贝南瓜', '水果玉米', '蒜苔', '蒜薹', '荷兰豆', '广红', '韭黄', '白玉菇', '麦芹', '大芹菜', '毛芹', '红薯', '螺丝椒', '青红线椒', '红线椒', '绿线椒', '红辣椒', '青辣椒', '鲜小米椒', '小米椒', '黄甜椒', '甜豆', '奶白菜', '白豆角', '苦瓜', '油麦菜', '油菜', '香葱', '龙须菜', '莲菜', '连菜', '波菜', '生姜', '姜', '白萝卜', '红心萝卜', '樱桃小萝卜', '萝卜苗', '象牙白萝卜', '花心萝卜', '净笋', '线椒', '黄芽菜', '菜心', '净蒜', '去皮蒜', '扒皮蒜', '新蒜', '白葱', '苦菊', '西蓝花', '青笋', '圆生菜', '罗马生菜', '叶生菜', '红萝卜', '园茄子', '圆茄子', '圆茄', '广茄', '长豆角', '扁豆角', '龙豆', '长江豆', '长豇豆', '豇豆', '芥菜', '紫甘蓝', '豆苗', '磨菇', '海鲜菇', '藕片', '西芹'],
    ...
    '冻货类': ['玉米红枣糕', '玉米发糕', '花卷', '火锅杂类丸子蟹排', '火锅油条', '荷叶饼', '小油条', '牛柳条', '蟹排', '冻', '冷冻', '冻货', '冻品', '火锅丸子', '馄饨', '丸子', '鸡块', '什锦菜', '猪头肉', '里昂火腿', '王中王火腿'],
...
PURCHASE_REVIEW_NAME_ORDER = {
    ...
    '桃子': 201, '西瓜': 202, '白心火龙果': 203, '火龙果': 204, '苹果': 205, '青提': 206, '油桃': 207, '香蕉': 208,
...
def parse_hotel_grocery_text(text, use_smart=True, preserve_order=False):
    ...
    normalized = re.sub(r'([）)])(?=[\u4e00-\u9fa5A-Za-z])', r'\1,', normalized)
    normalized = re.sub(r'[，、；;。\n\r\t]+', ',', normalized)
