...
HOTEL_CATEGORY_KEYWORDS = {
    '蔬菜类': [
        ...
        '波菜', '生姜', '姜', '白萝卜', '红心萝卜', '樱桃小萝卜', '萝卜苗', '象牙白萝卜', '花心萝卜', '净笋', '线椒', '黄芽菜', '菜心', '净蒜', '去皮蒜', '扒皮蒜', '新蒜', '毛蒜', '白葱',
...
HOTEL_CATEGORY_OVERRIDES = {
    ...
    '蔬菜类': ['水洗铁棍山药', '铁棍山药', '山药', '黄土豆', '贝贝南瓜', '水果玉米', '蒜苔', '蒜薹', '荷兰豆', '广红', '韭黄', '白玉菇', '麦芹', '大芹菜', '毛芹', '红薯', '螺丝椒', '青红线椒', '红线椒', '绿线椒', '红辣椒', '青辣椒', '鲜小米椒', '小米椒', '黄甜椒', '甜豆', '奶白菜', '白豆角', '苦瓜', '油麦菜', '油菜', '香葱', '龙须菜', '莲菜', '连菜', '波菜', '生姜', '姜', '白萝卜', '红心萝卜', '樱桃小萝卜', '萝卜苗', '象牙白萝卜', '花心萝卜', '净笋', '线椒', '黄芽菜', '菜心', '净蒜', '去皮蒜', '扒皮蒜', '新蒜', '毛蒜', '白葱', '苦菊', '西蓝花', '青笋', '圆生菜', '罗马生菜', '叶生菜', '红萝卜', '园茄子', '圆茄子', '圆茄', '广茄', '长豆角', '扁豆角', '龙豆', '长江豆', '长豇豆', '豇豆', '芥菜', '紫甘蓝', '豆苗', '磨菇', '海鲜菇', '藕片', '西芹'],
