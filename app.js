...
const Printer = {
    ...
    purchaseCategory(name) {
        ...
        const priorityGroups = [
            ...
            ['冻货类', ['花卷']],
            ['粮油调料类', ['素鸡', '泡椒', '辣椒段', '辣皮子', '白糖', '冰糖']],
            ['其他类', ['六六红', '水晶粉', '火锅宽粉', '火锅邵皮', '火锅苕皮', '芝麻酱', '丘比焙煎芝麻酱', '贡菜', '金针菇', '针金菇', '青岛纯生', '鞭炮笋', '香铃卷', '鲜玉米', '鲜虾', '薄荷叶', '椰果', '蛋黄派']],
        ];
        for (const [label, keywords] of priorityGroups) {
            if (keywords.some(keyword => text.includes(keyword))) return label;
        }
        const groups = [
            ['蔬菜类', ['菜', '广东菜心', '连菜', '莲菜', '豆芽', '莲花白', '花白', '白菜', '小白菜', '青菜', '菠菜', '芹', '毛芹', '大芹菜', '蒜苔', '蒜薹', '蒜苗', '新蒜', '扒皮蒜', '去皮蒜', '净蒜', '豆王', '长江豆', '黄瓜', '西红柿', '青椒', '红椒', '红辣椒', '青辣椒', '土豆', '红薯', '胡萝卜', '白萝卜', '红心萝卜', '樱桃小萝卜', '萝卜苗', '紫甘蓝', '西葫芦', '南瓜', '冬瓜', '洋葱', '茄子', '平菇', '香菇', '蘑菇', '葱', '西兰花', '龙须菜', '甜豆', '广红', '玉米']],
            ...
            ['粮油调料类', ['大米', '江米', '油', '白醋', '生抽', '酱', '辣椒', '辣椒段', '辣皮子', '泡椒', '素鸡', '白糖', '冰糖', '粉条', '粉丝', '米线', '红九九']],
            ['饮品乳品类', ['冰峰', '酸梅汤', '果汁', '饼干']]
        ];
    ...
    purchaseSupplierGroup(name) {
        ...
        const groups = {
            ...
            '王伟供应商': ['豇豆', '长豇豆', '白豆角', '螺丝椒', '蒜苔', '蒜薹', '韭菜', '平菇', '黄瓜', '西兰花', '西蓝花', '红萝卜', '胡萝卜', '洋葱', '净蒜', '生姜', '姜'],
            '自采': ['纯牛奶', '牛奶', '水果玉米', '青笋', '新蒜', '蒜苗', '白萝卜', '象牙萝卜']
        };
    ...
    purchaseSupplierItemRank(name) {
        const order = [
            ...
            '豇豆', '长豇豆', '螺丝椒', '蒜苔', '蒜薹', '韭菜', '白豆角', '平菇', '黄瓜', '西兰花', '西蓝花', '红萝卜', '胡萝卜', '洋葱', '净蒜', '生姜', '姜',
