...
const Printer = {
    ...
    purchaseCategory(name) {
        ...
        const groups = [
            ['蔬菜类', ['菜', '连菜', '莲菜', '豆芽', '莲花白', '花白', '白菜', '青菜', '菠菜', '芹', '毛芹', '大芹菜', '蒜苔', '蒜薹', '蒜苗', '新蒜', '扒皮蒜', '去皮蒜', '净蒜', '豆王', '长江豆', '黄瓜', '西红柿', '青椒', '红椒', '红辣椒', '青辣椒', '土豆', '红薯', '胡萝卜', '白萝卜', '红心萝卜', '樱桃小萝卜', '萝卜苗', '紫甘蓝', '西葫芦', '南瓜', '冬瓜', '洋葱', '茄子', '平菇', '香菇', '蘑菇', '葱', '西兰花', '龙须菜', '甜豆', '广红']],
